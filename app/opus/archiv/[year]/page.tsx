...
export default async function OpusArchivYear({ params }: { params: Promise<{ year: string }> }) {
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-6 md:px-10 py-20">
      <Link href="/opus/archiv" className="text-xs uppercase tracking-widest text-jko-red hover:text-[#0B0B0D]" style={{ fontFamily: "Inter, sans-serif" }}>
        ← Archiv
      </Link>
