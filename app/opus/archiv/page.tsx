...
export default function OpusArchiv() {
  return (
    <main className="max-w-[1400px] mx-auto px-6 md:px-10 py-20">
      ...
      <div className="mt-8">
        <Link href="/opus/archiv/kritiken" className="text-sm uppercase tracking-wider underline underline-offset-[6px] decoration-jko-red decoration-2 hover:decoration-jko-blue transition-colors" style={{ fontFamily: "Inter, sans-serif" }}>
