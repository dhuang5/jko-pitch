...
import { images, concerts } from "@/lib/content";
import { BrushHighlight, PaintedCircle } from "@/components/BrushHighlight";

export default function OpusGrauHome() {
    ...
    <main>
        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-16 items-end">
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4" style={{ fontFamily: "Inter, sans-serif" }}>
              <Link
                ...
                className="group inline-flex items-center gap-3 text-sm tracking-wide uppercase px-7 py-4 bg-[#0B0B0D] text-[#ECECEA] hover:bg-jko-red transition-colors relative"
                style={{ borderRadius: "45% 55% 50% 50% / 55% 45% 55% 45%" }}
              >
                Konzerte ansehen
                <span className="group-hover:translate-x-1 transition-transform">→</span>
              </Link>
              <Link href="/opus-grau/ueber-uns" className="text-sm underline underline-offset-[6px] decoration-jko-red decoration-2 hover:decoration-jko-blue transition-colors">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -bottom-3 -left-3 bg-[#ECECEA] px-4 py-2 text-[11px] tracking-[0.25em] uppercase border border-[#0B0B0D]/15"
        ...
        <div className="grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-6 md:col-start-7">
            ...
            <div className="mt-8 flex gap-4" style={{ fontFamily: "Inter, sans-serif" }}>
              <Link
                href="/opus-grau/termine"
                className="text-sm uppercase tracking-wide px-6 py-3.5 bg-[#0B0B0D] text-[#ECECEA] hover:bg-jko-blue transition"
                style={{ borderRadius: "45% 55% 50% 50% / 55% 45% 55% 45%" }}
              >
                Anmelden →
              </Link>
      ...
      <section className="max-w-[1400px] mx-auto px-6 md:px-10 py-20">
        <div className="grid md:grid-cols-12 gap-10">
          <div className="md:col-span-6 md:col-start-4">
            ...
            <div className="mt-10">
              <Link href="/opus-grau/ueber-uns" className="text-sm uppercase tracking-[0.2em] underline underline-offset-[6px] decoration-jko-red decoration-2 hover:decoration-jko-blue transition-colors" style={{ fontFamily: "Inter, sans-serif" }}>
                → Das Ensemble kennenlernen
              </Link>
            </div>
          </div>
      ...
      <section className="max-w-[1400px] mx-auto px-6 md:px-10 py-28 text-center relative">
        ...
        <div className="mt-10 flex flex-wrap gap-4 justify-center" style={{ fontFamily: "Inter, sans-serif" }}>
          <Link
            href="/opus-grau/mitglied"
            className="text-sm uppercase tracking-wide px-7 py-4 bg-[#0B0B0D] text-[#ECECEA] hover:bg-jko-red transition"
            style={{ borderRadius: "45% 55% 50% 50% / 55% 45% 55% 45%" }}
          >
            Mitglied werden
          </Link>
