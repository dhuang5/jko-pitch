...
export default function OpusGrauTermine() {
              ...
              <div className="md:col-span-2 flex md:justify-end items-start" style={{ fontFamily: "Inter, sans-serif" }}>
                {c.registrationOpen ? (
                  <button
                    ...
                    className="text-xs uppercase tracking-wider px-5 py-3 bg-[#0B0B0D] text-[#ECECEA] hover:bg-jko-red transition"
      ...
      {showAnmeldung && (
        ...
        >
          <motion.div
            ...
            className="bg-[#ECECEA] max-w-xl w-full p-10 relative shadow-2xl"
          ...
          >
            ...
            {submitted ? (
              ...
              >
                ...
                <button type="submit" className="w-full text-sm uppercase tracking-wide px-6 py-4 bg-[#0B0B0D] text-[#ECECEA] hover:bg-jko-red transition" style={{ borderRadius: "45% 55% 50% 50% / 55% 45% 55% 45%" }}>
