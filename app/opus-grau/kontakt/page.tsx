...
export default function OpusGrauKontakt() {
  return (
    <main className="max-w-[1400px] mx-auto px-6 md:px-10 py-20">
      ...
      <div className="grid md:grid-cols-12 gap-12 mt-20">
        ...
        <form className="md:col-span-7 space-y-4 p-8 border border-[#0B0B0D]/15 relative" style={{ fontFamily: "Inter, sans-serif", borderRadius: "24px 8px 24px 8px" }}>
          ...
          <button type="button" className="w-full text-sm uppercase tracking-wide px-6 py-4 bg-[#0B0B0D] text-[#ECECEA] hover:bg-jko-red transition" style={{ borderRadius: "45% 55% 50% 50% / 55% 45% 55% 45%" }}>
            Nachricht senden →
          </button>
        </form>
      </div>
