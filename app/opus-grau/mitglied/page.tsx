...
export default function OpusGrauMitglied() {
  return (
    <main className="max-w-[1400px] mx-auto px-6 md:px-10 py-20">
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-20">
        ...
        >
          ...
          <Link
            href="/opus-grau/kontakt"
            className="mt-8 inline-block text-sm uppercase tracking-wide px-6 py-4 bg-[#0B0B0D] text-[#ECECEA] hover:bg-jko-red transition"
        ...
        <motion.div
          ...
          className="relative p-10 bg-[#0B0B0D] text-[#ECECEA]"
          style={{ borderRadius: "8px 24px 8px 24px" }}
        >
          <div className="absolute -top-3 -right-3 w-12 h-12 flex items-center justify-center" style={{ background: "#E23A2F", borderRadius: "55% 45% 50% 50% / 48% 52% 48% 52%", color: "#ECECEA" }}>
          ...
          <p className="mt-6 text-[#ECECEA]/80 leading-relaxed text-lg" style={{ fontFamily: "Inter, sans-serif" }}>
          ...
          <div className="mt-6 grid grid-cols-3 gap-3" style={{ fontFamily: "Inter, sans-serif" }}>
            {["€ 25", "€ 50", "€ 100"].map((v, i) => (
              <button
                key={v}
                className={`px-4 py-4 border border-[#ECECEA]/30 hover:border-transparent transition ${
          ...
          <input placeholder="Eigener Betrag" className="w-full mt-3 px-4 py-4 bg-transparent border border-[#ECECEA]/30 placeholder:text-[#ECECEA]/40 outline-none focus:border-jko-yellow" style={{ fontFamily: "Inter, sans-serif", borderRadius: "12px" }} />
          <button className="mt-4 w-full text-sm uppercase tracking-wide px-6 py-4 bg-jko-yellow text-[#0B0B0D] hover:bg-[#ECECEA] transition" style={{ fontFamily: "Inter, sans-serif", borderRadius: "45% 55% 50% 50% / 55% 45% 55% 45%" }}>
            Zur sicheren Zahlung →
          </button>
          <p className="mt-4 text-xs text-[#ECECEA]/60" style={{ fontFamily: "Inter, sans-serif" }}>
